...
const Instagram = () => {
  const images = [inst1, inst2, inst3];

  const imagesBlock = Array.from({ length: 3 }).map((el, index) => (
    <img
      key={`image-key-${index}`}
      className={"c-instagram__img c-instagram__img-" + index}
      alt="inst-img"
      src={images[`${index}`]}
    ></img>
  ));
    ...
    <>
      <div className="c-instagram">
        <div className="c-instagram__wrapper">
          <div className="c-instagram__left">
            <div className="c-instagram__decr">
              <p className="e-instagram__descr">Follow us on Instagram</p>
              <div className="c-instagram__title">
                <h4 className="c-instagram__title-text">@createx_store</h4>
              </div>
              <a
                className="c-instagram__link"
              ...
              >
                <svg
                  ...
                  className="c-instagram__link-img"
                >
                  <path
          ...
          <div className="c-instagram__right">{imagesBlock}</div>
        </div>
      </div>
    </>
  );
